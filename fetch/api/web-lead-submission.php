...
try {
    ...
    $mail->SMTPAuth = true;
   $mail->Username = 'Vinita.ledgermen@gmail.com';
    $mail->Password = 'istrvyhvsamrpgdb'; 
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;
    $mail->CharSet = 'UTF-8';
    $mail->setFrom('Vinita.ledgermen@gmail.com', 'Vinita Goyal');
    ...
    $mail->clearAllRecipients();
    $mail->addAddress('argservicesindia@gmail.com');
    $mail->isHTML(true);
